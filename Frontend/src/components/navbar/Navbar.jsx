    ...
    <div className="Navbar">
      <div className="navigation-bar">
        <div className="left-nav">
          <div className="icon" onClick={backHomePage}>
            <svg
        ...
        <div className="right-nav">
          ...
          {loggedOn ? (
             <>
            <div className="hoffer">
            <Link to="/home" className="dropbtn2" onClick={toggleDropdown}> 
              {currentUser} 
            </Link>
            ...
            <Link to="/login" className="dropbtn" onClick={toggleDropdown}>
              {loginText}
            </Link>
          )}
            <div className="dropdown-content">
              {currentUser && (
                <React.Fragment>
                  ...
                  <Link value="logout" to="/" onClick={logout}>
                    Logout
                  </Link>
                </React.Fragment>
              )}
